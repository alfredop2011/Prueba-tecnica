    ...
    <form @submit.prevent="submit" novalidate v-cloak>
        <div class="row">
            <div class="col-md-6 text-center">
                ...
                <div class="mrg-top-1em text-danger"  v-for="error of errors['avatar']" :key="error" >
                    {{ error }}
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div
                    ...
                    <span class="help-block" v-for="error of errors['name']" :key="error">
                        {{ error }}
                    </span>
                </div>
                ...
                <div
                    ...
                    <span class="help-block" v-for="error of errors['email']" :key="error">
                        {{ error }}
                    </span>
                </div>
                ...
                <div
                    ...
                    <span class="help-block" v-for="error of errors['birth_date']" :key="error">
                        {{ error }}
                    </span>
                </div>
            </div>
